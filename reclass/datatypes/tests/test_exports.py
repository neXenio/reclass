...
class TestInvQuery(unittest.TestCase):
    ...
    def test_malformed_invquery(self):
        with self.assertRaises(ParseError):
            p = Parameters(
                {"exp": "$[ exports:a exports:b == self:test_value ]"}, SETTINGS, ""
            )
        with self.assertRaises(ParseError):
            p = Parameters(
                {"exp": "$[ exports:a if exports:b self:test_value ]"}, SETTINGS, ""
            )
        with self.assertRaises(ParseError):
        ...
        with self.assertRaises(ParseError):
            p = Parameters(
                {
                    "exp": "$[ exports:a if exports:b == self:test_value and exports:c = self:test_value2 ]"
                },
                SETTINGS,
                "",
            )
        with self.assertRaises(ParseError):
            p = Parameters(
                {
                    "exp": "$[ exports:a if exports:b == self:test_value or exports:c == ]"
                },
                SETTINGS,
                "",
            )
        with self.assertRaises(ParseError):
            p = Parameters(
                {
                    "exp": "$[ exports:a if exports:b == self:test_value anddd exports:c == self:test_value2 ]"
                },
                SETTINGS,
                "",
            )
    ...
    def test_if_expr_invquery_with_refs(self):
        e = {"node1": {"a": 1, "b": 2}, "node2": {"a": 3, "b": 4}}
        p = Parameters(
            {"exp": "$[ exports:a if exports:b == self:test_value ]", "test_value": 2},
            SETTINGS,
            "",
        )
    ...
    def test_if_expr_invquery_wth_and(self):
        e = {
            "node1": {"a": 1, "b": 4, "c": False},
            "node2": {"a": 3, "b": 4, "c": True},
        }
        p = Parameters(
            {"exp": "$[ exports:a if exports:b == 4 and exports:c == True ]"},
            SETTINGS,
            "",
        )
        r = {"exp": {"node2": 3}}
    ...
    def test_if_expr_invquery_wth_or(self):
        ...
        p = Parameters(
            {"exp": "$[ exports:a if exports:b == 4 or exports:b == 3 ]"}, SETTINGS, ""
        )
        r = {"exp": {"node1": 1, "node2": 3}}
        p.interpolate(e)
        self.assertEqual(p.as_dict(), r)
    ...
    def test_list_if_expr_invquery_with_and(self):
        ...
        p = Parameters(
            {"exp": "$[ if exports:b == 2 and exports:c == green ]"}, SETTINGS, ""
        )
        r = {"exp": ["node1"]}
        p.interpolate(e)
        self.assertEqual(p.as_dict(), r)
    ...
    def test_list_if_expr_invquery_with_and(self):
        ...
        p = Parameters(
            {"exp": "$[ if exports:b == 2 or exports:b == 4 ]"}, SETTINGS, ""
        )
        r1 = {"exp": ["node1", "node3"]}
        r2 = {"exp": ["node3", "node1"]}
        p.interpolate(e)
